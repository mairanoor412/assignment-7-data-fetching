    ...
    <div className="overflow-x-hidden bg-white">
      ...
      <div>
        ...
        <div className="grid lg:grid-cols-2 gap-7 md:gap-10 lg:gap-1 ">
          {/* Client side */}
          <div className="h-[270px] pt-8 w-[320px] sm:w-[400px] md:w-[500px]  m-auto flex flex-col gap-3 py-5 px-5 rounded-[10px] bg-white shadow-xl transition-transform transform hover:scale-105 hover:translate-y-2 duration-500 ease-out">
            ...
            <Link href="/client-side" target="_blank">
              <button className="px-10 py-2 text-[12px] lg:text-[14px] bg-yellow-500 hover:bg-yellow-600 rounded-[10px] text-white"> Client Side Rendering </button>
            </Link>
          </div>
            

            {/* server side  */}
          <div className="h-[270px] pt-12 w-[330px] sm:w-[400px] md:w-[500px] m-auto flex flex-col gap-3 py-5 px-5 rounded-[10px] bg-white shadow-xl transition-transform transform hover:scale-105 hover:translate-y-2 duration-500 ease-out">
            ...
            <Link href="/server-side" target="_blank">
              <button className="px-10 py-2 text-[12px] lg:text-[14px] bg-yellow-500 hover:bg-yellow-600 rounded-[10px] text-white"> Server Side Rendering </button>
            </Link>
          </div>

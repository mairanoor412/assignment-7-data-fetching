...
const ClientSide = () => {
    ...
    return (
        <div>
            <div className="mt-28 grid grid-cols-1 justify-items-center gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 rounded-[5px] ">
                {loading ? (
                    ...
                    <div key={index}>
                        ...
                        <div className="w-[285px] sm:w-[320px] h-auto bg-white shadow-xl rounded-[10px] px-3 py-5">
                            ...
                            <h1 className="text-[20px]  font-[600] mt-4 line-clamp-1"> {products.title} </h1>
                            <div className="h-[20px] mt-2 flex justify-between items-center">
                                <p className="text-[12px] text-zinc-600  "> {products.category}</p>
                                <p className="text-[12px] text-yellow-500 ">{products.rating.rate} ({products.rating.count} reviews)</p>
                            </div>
                            <p className="my-3 text-[16px] line-clamp-2"> {products.description} </p>
